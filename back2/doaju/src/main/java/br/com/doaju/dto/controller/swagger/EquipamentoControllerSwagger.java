...
@Api(tags = "Controller de Equipamento")

public interface EquipamentoControllerSwagger {
	
	@ApiOperation("Lista um equipamento")
	public List<EquipamentoDTO> listar();
	
	@ApiOperation("Salva um equipamento")
	public ResponseEntity<?> salvar(@RequestBody EquipamentoRequest equipamentoRequest);
	
	@ApiOperation("Busca um equipamento")
	public ResponseEntity<?> buscar(@PathVariable Long id);
	
	@ApiOperation("Atualiza um equipamento")
	public ResponseEntity<?> atualizar(@RequestBody EquipamentoRequest equipamentoRequest, @PathVariable Long id);
	
	@ApiOperation("Exclui um equipamento")
	public void excluir(@PathVariable Long id);
	
	@ApiOperation("Busca um equipamento por usuário")
